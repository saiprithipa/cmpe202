...
public class GumballWorld extends World
{
    ...
    private void prepare()
    {
        ...
        addObject(quarter2,145,392);
        quarter2.setLocation(60,348);
        FakeQuarter fakeQuarter2 = new FakeQuarter();
        addObject(fakeQuarter2,67,424);
        fakeQuarter2.setLocation(57,429);
